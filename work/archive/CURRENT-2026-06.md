# Current state — archive (entries before 2026-07-01)

> Rotated out of [work/CURRENT.md](../CURRENT.md) on 2026-08-02 to keep that
> file readable in one sitting. Everything below is preserved **verbatim** —
> the May–June 2026 sprint entries plus the May-era "Where we are" /
> run-locally / caveats / pointers sections that they referenced.
