...
void main() {
  testWidgets(
    ...
    'under the app-real 2-decimal format',
    (tester) async {
      setTestSize(tester, const Size(1300, 1800));
      await tester.pumpWidget(
        buildProjectionHost(currencyFormat: moneyFormat('USD')),
      );
      ...
      await tester.pumpWidget(
        buildProjectionHost(
          ...
          projectionFetcher: fixtureFetcher(
            (y) =>
                projectionFixture(years: y, monthlyIncomeAtRetirement: 3300.75),
          ),
        ),
      );
      await tester.pumpAndSettle();
