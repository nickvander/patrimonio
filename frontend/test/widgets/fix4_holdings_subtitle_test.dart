...
void main() {
  testWidgets(
    ...
    'truncates on a narrow (mobile) width',
    (tester) async {
      ...
      expect(
        tester.getSize(acctNarrow).width,
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      final sizes = acctTexts
          ...
          .toList();
      expect(
        sizes.where((s) => s.height > 20).length,
        1,
