...
bool _tooltipShowing(WidgetTester tester) => _chartData(tester)
    .barGroups
    .any((g) => g.showingTooltipIndicators.isNotEmpty);
...
void main() {
  testWidgets(
      ...
      'tap-up "interested" (the pinned-tooltip bug)', (tester) async {
  ...
  testWidgets(
      ...
      'to onMonthSelected and the tooltip is not left pinned', (tester) async {
    String? selected;
    _useSurface(tester, const Size(1000, 900));
    ...
    expect(selected, '2026-05',
        reason: 'TransientTooltipBarChart must chain the tap-to-filter '
