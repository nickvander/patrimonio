...
class AppLocalizationsEn extends AppLocalizations {
  ...
  @override
  String get txOriginalText => 'Original text';
  ...
  String projValueEntryRangePercent(String min, String max) {
    return 'Enter a rate between $min and $max';
  }

  @override
  String projValueEntryWholeYears(int min, int max) {
    return 'Enter a whole number of years between $min and $max';
  }
  ...
  String pfUnrecognizedTypes(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Includes account types we don\'t recognize yet',
      one: 'Includes an account type we don\'t recognize yet',
    );
    return '$_temp0';
  }
  ...
  @override
  String get lwSyncBannerDismiss => 'Dismiss for a week';
  ...
  String lwNotifSinceVisitDetail(String date) {
    return 'Since your last visit · $date. Tap to review.';
  }
  ...
  String lwNotifBellUnread(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Notifications, $count unread alerts',
      one: 'Notifications, 1 unread alert',
    );
    return '$_temp0';
  }
  ...
  @override
  String get pfMoversTodayTitle => 'Top movers today (by \$)';

  @override
  String get pfBestWorstAllTime => 'Best & worst (all time)';
  ...
  String lendScheduleRowMeta(String balance, String interest) {
    return 'Bal $balance · int $interest';
  }
  ...
  @override
  String get lendLinkedPaymentUntitled => 'Linked payment';

  @override
  String get lendOffBankBadge => 'Recorded manually';

  @override
  String get lendMatchStrong => 'Strong match';

  @override
  String get lendMatchLikely => 'Likely match';

  @override
  String get lendMatchPossible => 'Possible match';

  @override
  String get lendMatchNameHit => 'Name matches';
  ...
  String lendToastCheckField(String field) {
    return 'Fix “$field” to continue';
  }

  @override
  String get lendErrEnterPayment => 'Enter a payment amount greater than 0';
  ...
  String rebUnclassifiedBalanceFootnote(String pct) {
    return 'Unclassified: $pct — account balances without holdings detail, kept in the totals';
  }
  ...
  @override
  String get dashWidgetJustNowShort => 'now';
